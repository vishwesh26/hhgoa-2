...
INDIC_SYNONYMS = {
    ...
    "मॅनहॅटन": ["manhattan", "मैनहट्टन"],
    "मैनहट्टन": ["manhattan", "मॅनहॅटन"],
    "manhattan": ["manhattan", "मॅनहॅटन", "मैनहट्टन"],
    "ऑक्सिजन": ["oxygen", "प्राणवायू"],
    "oxygen": ["oxygen", "ऑक्सिजन", "प्राणवायू"],
    "प्रोजेक्ट": ["project", "प्रकल्प", "योजना"],
    "project": ["project", "प्रकल्प", "प्रोजेक्ट", "योजना"],
    "bomb": ["bomb", "बॉम्ब", "अणुबॉम्ब"],
    "atomic": ["atomic", "अणु", "अणुबॉम्ब", "परमाणु"],
    "nuclear": ["nuclear", "अणु", "नाभिकीय"],
    "war": ["war", "युद्ध", "महायुद्ध"],
    "world": ["world", "जग", "विश्व", "महायुद्ध"],
    "history": ["history", "इतिहास"],
    "army": ["army", "सेना", "सैन्य", "लष्कर"],
    "energy": ["energy", "ऊर्जा"],
    "water": ["water", "पाणी", "जल"],
    "sun": ["sun", "सूर्य", "प्रकाश"]
}
